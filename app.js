...
app.get('/auth/instagram/callback', passport.authenticate('instagram', { failureRedirect: '/signin' }), (req, res) => {
...
app.get('/auth/github/callback', passport.authenticate('github', { failureRedirect: '/signin' }), (req, res) => {
  res.redirect(req.session.returnTo || '/');
});
...
app.get('/auth/linkedin/callback', passport.authenticate('linkedin', { failureRedirect: '/signin' }), (req, res) => {
  res.redirect(req.session.returnTo || '/');
});
...
app.get('/auth/steam/callback', passport.authorize('openid', { failureRedirect: '/signin' }), (req, res) => {
  res.redirect(req.session.returnTo || '/');
});
app.get('/auth/pinterest', passport.authorize('pinterest', { scope: 'read_public write_public' }));
app.get('/auth/pinterest/callback', passport.authorize('pinterest', { failureRedirect: '/signin' }), (req, res) => {
